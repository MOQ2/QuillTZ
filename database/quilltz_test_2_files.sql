...
CREATE TABLE `files` (
  ...
  PRIMARY KEY (`file_ref`),
  KEY `fk_user_id` (`user_id`),
  CONSTRAINT `fk_user_id` FOREIGN KEY (`user_id`) REFERENCES `clients` (`user_id`)
...
INSERT INTO `files` VALUES ('c:\\Users\\qadim\\OneDrive - student.birzeit.edu\\3_year_2\\Database\\QuillTZ\\website\\uploads\\adsf.sql','adsf.sql',94);
